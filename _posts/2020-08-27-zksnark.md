...
With the information of `wᵢ`, prover theoretically knows everything to
construct Aₚ, Bₚ and Cₚ.


Remember `Lᵢ(x) = β*Aᵢ(x) + α*Bᵢ(x) + Cᵢ(x)`, 
...
this is how roughly how code is mapped to the discussed so far:
